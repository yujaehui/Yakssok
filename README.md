...
- [🛠️ 기술 스택](#️🛠️-기술-스택)
- [🚀 트러블 슈팅](#️🚀-트러블-슈팅)
  - [1. iOS 알림 제한 문제 해결](#1.-iOS-알림-제한-문제-해결)
  - [2. Realm 데이터 삭제 안정화](#2.-Realm-데이터-삭제-안정화)
- [🗂️ 파일 디렉토리 구조](#️🗂️-파일-디렉토리-구조)
- [🛣️ 향후 계획](#️🛣️-향후-계획)
...
## 1. iOS 알림 제한 문제 해결: 영양제 등록 로직 최적화
...
## 2. Realm 데이터 삭제 안정화: 영양제 체크 해제 문제 해결
